...
function mca_mv_to_nm_conversion(V::Array{Float64}, Q::Float64, y::Array{Float64})
    ...
    bin_index_less180 = findall(V.< 0.0);
    bin_index_180_225 = findall((V.> 0.0) .& (V.<= 9.03331589337687));
    bin_index_225_250 = findall((V.>  9.03331589337687) .& (V.<= 11.0517570739768));
    bin_index_250_300 = findall((V.>  11.0517570739768) .& (V.<= 14.2239365441507));
    bin_index_300_350 = findall((V.> 14.2239365441507) .& (V.<= 17.2454627949173));
    bin_index_350_400 = findall((V.> 17.2454627949173) .& (V.<= 20.6660964874571));
    bin_index_400_450 = findall((V.> 20.6660964874571) .& (V.<= 23.2383963406533));
    bin_index_450_500 = findall((V.> 23.2383963406533) .& (V.<= 27.7493391661605));
    bin_index_500_550 = findall((V.> 27.7493391661605) .& (V.<= 33.2934220849956));

    bin_index_550_600 = findall((V.> 33.2934220849956) .& (V.<= 41.1185438893798));
    bin_index_600_700 = findall((V.> 41.1185438893798) .& (V.<= 58.749864054563));
    bin_index_700_800 = findall((V.> 58.749864054563) .& (V.<= 74.0929045616924));
    bin_index_800_900 = findall((V.> 74.0929045616924) .& (V.<= 89.3882006531462));
    bin_index_900_1000 = findall((V.> 89.3882006531462) .& (V.<= 107.03344369944));
    bin_index_1000_1100 = findall((V.> 107.03344369944) .& (V.<= 116.540783616229)); #leave as they are >10000 nm
    bin_index_1100_1200 = findall((V.> 116.540783616229) .& (V.<= 131.348520985419));
    bin_index_1200_1300 = findall((V.> 131.348520985419) .& (V.<=148.839150764144));
    # bin_index_1300_1400 = findall((V.> 148.839150764144) .& (V.< 161.778298535257));
    # bin_index_1400_1500 = findall((V.> 161.778298535257) .& (V.< 183.279613979509));
    ...
    # Total Concentration on each of the 17 bins 
    C_Dia_less180 = sum(y[bin_index_less180]) / Q /0.1
    C_Dia_180_225 = sum(y[bin_index_180_225]) / Q /0.1
    C_Dia_225_250 = sum(y[bin_index_225_250]) / Q /0.1
    C_Dia_250_300 = sum(y[bin_index_250_300]) / Q /0.1
    C_Dia_300_350 = sum(y[bin_index_300_350]) / Q /0.1
    C_Dia_350_400 = sum(y[bin_index_350_400]) / Q /0.1
    C_Dia_400_450 = sum(y[bin_index_400_450]) / Q /0.1
    ...
    C_mca_hist_bins = [ C_Dia_less180, C_Dia_180_225,C_Dia_225_250, C_Dia_190_250,C_Dia_250_300,C_Dia_300_350,C_Dia_350_400,C_Dia_400_450,C_Dia_450_500,C_Dia_500_550,C_Dia_550_600,C_Dia_600_700,C_Dia_700_800,C_Dia_800_900,C_Dia_900_1000,C_Dia_1000_1100,C_Dia_1100_1200,C_Dia_1200_1300]
    Dia_mca_hist_bins = [180, 225,250, 300, 350, 400, 450, 500, 550, 600, 700, 800, 900,1000,1100,1200,1300]
